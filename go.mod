...
require (
	...
	code.byted.org/influxdb/telegraf v0.0.0-20240425070637-412f725d0722 // indirect
...
require code.byted.org/observability/oneagent-byted/go_plugins v0.0.1

require code.byted.org/aiops/oneagent-example-plugins v0.0.0-20240918040620-ffda6e360c57

replace code.byted.org/observability/oneagent-byted/go_plugins v0.0.1 => /workspaces/oneagent-byted/go_plugins
